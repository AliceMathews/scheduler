...
describe("Application", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    // 4. Enter the name "Alice Mathews" into the input with the placeholder "Enter Student Name".
    fireEvent.change(getByPlaceholderText(appointment, "Enter Student Name"), {
      target: { value: "Alice Mathews" }
    });
    ...
    // 8. Wait until the element with the text "Alice Mathews" is displayed.
    await waitForElement(() => getByText(appointment, "Alice Mathews"));
